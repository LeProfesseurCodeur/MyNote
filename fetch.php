...
if(isset($_POST["query"])) {
  $search = mysqli_real_escape_string($db, $_POST["query"]); // Protège les caractères spéciaux d'une chaîne pour l'utiliser dans une requête SQL, 
                                        ...
                                        <div class='modal-content'>
                                            ...
                                            <form method='POST' action='update.php'>
                                                ...
                                                <div class='modal-footer'>
                                                    <div class='form-group'>
                                                        <button class='btn btn-success' type='submit' name='updateNote'>Confirmer</button>
                                            ...
                                            <form method='POST' action='delete.php'>
                                                <div class='modal-footer'>
                                                    <div class='form-group'>
                                                        ...
                                                        <button class='btn btn-success' type='submit' name='deleteNote'>Confirmer</button>
                                                        <button class='btn btn-danger' type='button' data-dismiss='modal' aria-hidden='true'>
                                                            Cancel
                                                        </button>
                                                    </div>
